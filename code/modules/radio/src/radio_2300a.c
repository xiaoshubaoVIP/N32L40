...
#include "radio/inc/radio_2300a_driver.h"
...
#include "radio/inc/2300a_params_x_sense_en.h"
#elif defined(SUPPORT_X_SENSE_UL)
#include "radio/inc/2300a_params_x_sense_ul.h"
#elif defined(SUPPORT_AEGISLINK_EN)
#include "radio/inc/2300a_params_aegislink_en.h"
#elif defined(SUPPORT_AEGISLINK_UL)
#include "radio/inc/2300a_params_aegislink_ul.h"
#elif defined(SUPPORT_RADIO_TEST)
#include "radio/inc/2300a_params_radio_test.h"
#endif
...
void RF_Config(eRadioCfgMode CfgMode)
{
	...
	CMT2300A_SetInterruptPolar(true);//true高电平有效
	...
	else if(CfgMode == eRadioCfgTestRxMode)
	{
...
void RF_Send(uint8_t buf[], uint16_t len, uint16_t packnum, uint32_t timeout)
{
	...
	CMT2300A_WriteReg(CMT2300A_CUS_PKT27,packnum);
	...
	//CMT2300A_WriteReg(CMT2300A_CUS_PKT29,Reg&0x7F);                  //关闭restore TX FIFO
	...
	//Reg=CMT2300A_ReadReg(CMT2300A_CUS_PKT29);                        
	//CMT2300A_WriteReg(CMT2300A_CUS_PKT29,Reg|0x80);                  //打开restore TX FIFO
