...
{
	// xosc_aac_code[2:0] = 2
	uint8_t tmp = (~0x07) & CMT2300A_ReadReg(CMT2300A_CUS_CMT10);
	CMT2300A_WriteReg(CMT2300A_CUS_CMT10, tmp|0x02);
}

void CMT2300A_SetTxPrefix(void)
{
	uint8_t tmp = CMT2300A_ReadReg(CMT2300A_CUS_PKT26);

	tmp &= ~CMT2300A_MASK_TX_PREFIX_TYPE;
	CMT2300A_WriteReg(CMT2300A_CUS_PKT26,(tmp|CMT2300A_TX_PREFIX_PREAM));
}
