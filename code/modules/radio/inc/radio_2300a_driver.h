...
// #define CMT2300A_SetGpio1In()		HalGpioSetMode(PIN_RADIO_GPIO_1, PIN_MODE_INPUT)
// #define CMT2300A_SetGpio2In()		HalGpioSetMode(PIN_RADIO_GPIO_2, PIN_MODE_INPUT)
// #define CMT2300A_SetGpio3In()		HalGpioSetMode(PIN_RADIO_GPIO_3, PIN_MODE_INPUT)
// #define CMT2300A_ReadGpio1()		HalGpioRead(PIN_RADIO_GPIO_1)
// #define CMT2300A_ReadGpio2()		HalGpioRead(PIN_RADIO_GPIO_2)
// #define CMT2300A_ReadGpio3()		HalGpioRead(PIN_RADIO_GPIO_3)
#define CMT2300A_DelayMs(ms)		   DelayMs(ms)
#define CMT2300A_DelayUs(us)		   DelayUs(us)
#define CMT2300A_GetTickCount()		SystemGetTick()
...
void CMT2300A_ConfigInt1Interrupt(uint8_t nInt1Sel);
void CMT2300A_ConfigInt2Interrupt(uint8_t nInt2Sel);
...
void CMT2300A_DutyCycle(BOOL bEnable);
void CMT2300A_XoscAacCode(void);
